...
Doubletype은 macOS 메뉴 바에서 실행되는 이중 언어 초안 작성 앱이에요. 영어와 한국어를 번갈아 쓰는 순간들 — 앱을 전환하거나 입력기를 바꾸는 번거로움 없이, 생각나는 대로 바로 쳐낼 수 있게 만들어졌습니다.
...
1. **[Releases](https://github.com/Ashutos1997/doubletype/releases)** 페이지에서 최신 `.dmg`를 다운로드하세요.
2. DMG를 열고 **Doubletype.app**을 **Applications** 폴더로 드래그해 주세요.
